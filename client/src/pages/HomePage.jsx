...
function HomePage() {
  return (
    <div className="ml-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center lg:pt-32">
    <p className="mx-auto -mt-4 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">Welcome to
        <span class="border-b border-dotted border-slate-300"> URL Videos !</span>
    </p>

    <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        <span className="inline-block">Subidor de
            ...
            <span className="relative"> URLs</span></span>
        </span>
        <span className="inline-block"></span>
    </h1>

    <p className="mx-auto mt-9 max-w-2xl text-lg tracking-tight text-slate-700 sm:mt-6">
        <span className="inline-block">Lorem, ipsum dolor sit amet consectetur adipisicing eli maxime.</span>
